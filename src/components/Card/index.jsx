...
const Card = () => {
    ...
    <CardContainer>
        ...
        <Content>
            <UserInfo>
                <UserPicture src="https://avatars.githubusercontent.com/u/18087360?v=" />
                <div>
                    <h4>Caio Philipe</h4>
                    <p>Há 8 minutos</p>
                </div>
            ...
            <PostInfo>
                ...
                <p>
                    Projeto feito no curso de html e css no bootcamp da dio da XP investimentos...<strong>Saiba Mais</strong>
                </p>
            </PostInfo>
            <HasInfo>
